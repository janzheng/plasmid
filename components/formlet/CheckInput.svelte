	...
	<div class=" _form-control">
		<div id={id} class="" >
			...
			{#each options as item}
		  	<label class="_form-checkbox-label __checkbox " bind:this={ref} for={item['value']}>
			...
			{#if showOtherCheckbox}
				<label class="_form-checkbox-label __checkbox" for={`${id}-other`}>
					...
					<input type="checkbox" 
						...
						class={`_form-input ${styles['fieldClasses']} `}
					/>

					<div class="checkbox _padding ">
						<div class="checkbox-content _padding-left-2">
							<slot name='itemlabel'>
								<div class="_md-pfix">
