...
export const sharedSpaces = [
  ...
  {
    name: 'instill-science',
    spaceName: 'Instill Science',
    description: `A place to discuss science, share work, and find mentors and collaborators`,
    settings: {
      blockType: 'PostList',
      uploadImage: false,
      classMode: 'tight', // tight, oneline, default
