...
// this is mostly set up for client uploads currently 6/30/22
...
export const uploadFileToDeta = async (file, projId, baseName, apiKey, progress, fetch, reader = new FileReader(), verbose=false) => {
  if (verbose)
    ...
    if (initUpload.ok) {
      ...
      reader.onload = async function (e) {
        ...
        if (detaUpload.ok) {
          ...
          if (verbose)
            console.log('Upload > chunk:', detaUploadJson)
