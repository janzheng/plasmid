  ...
  (0, _createClass2.default)(Cytosis, [{
      ...
      return new Promise(function (resolve, reject) {
        ...
        Cytosis.getTables({
          ...
          if (!_config || !_this.airBase.tables || _this.airBase.tables.length == 0) {
            throw new Error("[Cytosis] \u2014 couldn\u2019t find a '_cytosis' table with row ".concat(tableQuery, " or 'tables' filled out with the names of tables to load"));
            reject(_this);
          }
    ...
    value: function getTables(_ref) {
      ...
      function getTablePromise(_ref2) {
        ...
        try {
          ...
          console.error('Airtable async err', e);
        }
      }
    ...
    value: function find(findStr, tables) {
      ...
      function matchField(str, tables, fields) {
        var results = [];
        Object.keys(tables).map(function (table) {
          if (!tables[table]) throw new Error("[Cytosis] \u2014 Couldn\u2019t find a match. Make sure you're looking in the right place. Reference table/string: (".concat(tables[table], " / ").concat(findStr, "). Required Format was probably wrong: { Content: [ row, row, row], Tags: [ row, row, row ] }. "));
    ...
    key: "delete",
    value: function _delete(tableName, recordId) {
      if (!Cytosis.preCheck(this.airKey, this.airBase)) return;
      var base = this.base;
    ...
    key: "saveLinkedTable",
    value: function () {
      var _saveLinkedTable = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee2(stringList, targetTableName, sourceTable) {
        var colName,
            recordIds,
            _args2 = arguments;
        return _regenerator.default.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                colName = _args2.length > 3 && _args2[3] !== undefined ? _args2[3] : 'Name';
                _context2.next = 3;
                return stringList.reduce(function () {
                  var _ref3 = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee(resultPromise, listItem) {
                      ...
                      while (1) {
                        switch (_context.prev = _context.next) {
                          ...
                          case 6:
                            ...
                            return _context.abrupt("return", _result.concat(record.getId()));
                          ...
                          case 23:
                            ...
                            return _context.abrupt("return", _result.concat(recordId.id));
              ...
              case 3:
                recordIds = _context2.sent;
                return _context2.abrupt("return", recordIds);
      ...
      function saveLinkedTable(_x, _x2, _x3) {
    ...
    value: function getNames(recordArray) {
      ...
      try {
        for (_iterator14.s(); !(_step14 = _iterator14.n()).done;) {
          ...
          if (record) results.push(record.fields['Name']);
        }
      } catch (err) {
        _iterator14.e(err);
      } finally {
    ...
    key: "getFields",
    value: function getFields(recordArray, fieldName) {
      var results = [];
    ...
    key: "configure",
    value: function configure(_ref4) {
      var airKey = _ref4.airKey,
          airBase = _ref4.airBase,
          tables = _ref4.tables,
          tableQuery = _ref4.tableQuery,
