  ...
  (0, _createClass2.default)(Cytosis, [{
    ...
    value: function () {
      var _getRecord = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee(_ref4) {
        var recordId, airKey, baseId, tableName, endpointUrl, base, record;
        return _regenerator.default.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                recordId = _ref4.recordId, airKey = _ref4.airKey, baseId = _ref4.baseId, tableName = _ref4.tableName, endpointUrl = _ref4.endpointUrl;
                _context.prev = 1;
                Airtable.configure({
                  endpointUrl: endpointUrl || "https://api.airtable.com",
                  apiKey: airKey
